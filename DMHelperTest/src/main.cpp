...
int main(int argc, char *argv[]) {
    ...
    try {
        ...
        qDebug() << "DM Helper Test threw an exception: " << e.what();
    } catch (...) {
        qDebug() << "DM Helper Test threw an unknown exception";
    }
