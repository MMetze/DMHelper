...
{
    ui->btnEditCamera->setEnabled(locked);
    ui->btnCameraFullMap->setEnabled(locked);
    ui->btnCameraCouple->setEnabled(locked);
    ui->btnCameraVisible->setEnabled(locked);
    ui->btnCameraSelect->setEnabled(locked);
}
