...
static const char *fireFragmentShader = "#version 410 core\n"
    ...
    "    // Intensity scales gently: even at 0 the fire still reads as fire (no 'lazy fire' mode).\n"
    "    float freq = 1.6 + u_intensity * 0.6;\n"
    "    float flickerRate = 1.4 + u_intensity * 0.6;\n"
    "    vec2 flow = uv * (0.85 + u_intensity * 0.15);\n"
    "    float speed = 0.55 + u_intensity * 0.20;\n"
