...
Component.prototype.createOperations = function()
{
    ...
    if (systemInfo.productType === "windows") {
        ...
        component.addOperation("CreateShortcut", "@TargetDir@/DMHelperClient.exe", "@StartMenuDir@/DM Helper Client.lnk",
            "workingDirectory=@TargetDir@", "description=Open the DM Helper Client");

        component.addOperation("CreateShortcut", "@TargetDir@/maintenancetool.exe", "@StartMenuDir@/Uninstall DM Helper Client.lnk",
            "workingDirectory=@TargetDir@", "description=Open the DM Helper Client maintenance tool");
    }
}
