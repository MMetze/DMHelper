...
CampaignObjectBase* PublishGLMapVideoRenderer::getObject()
{
    return _map;
}
...
bool PublishGLMapVideoRenderer::deleteOnDeactivation()
{
    return true;
}

void PublishGLMapVideoRenderer::setBackgroundColor(const QColor& color)
{
    _color = color;
    emit updateWidget();
}

void PublishGLMapVideoRenderer::initializeGL()
{
...
void PublishGLMapVideoRenderer::resizeGL(int w, int h)
{
...
void PublishGLMapVideoRenderer::paintGL()
{
...
const QImage& PublishGLMapVideoRenderer::getImage() const
{
    return _image;
}

QColor PublishGLMapVideoRenderer::getColor() const
{
    return _color;
}

void PublishGLMapVideoRenderer::setImage(const QImage& image)
{
    if(image != _image)
    {
        _image = image;
...
void PublishGLMapVideoRenderer::setOrthoProjection()
{
