...
{
#ifdef Q_OS_MAC
        DMHMessageBox::information(nullptr, QString("Syrinscape integration"), QString("Syrinscape 3rd party integration is unfortunately only supported on Windows at this time. Audio playback of Syrinscape audio will be integrated into DMHelper as soon as this is supported!"));
#else
