...
public:
    ...
    explicit TokenEditDialog(const QString& tokenFilename = QString(),
                             bool backgroundFill = false,
                             const QColor& backgroundFillColor = Qt::white,
                             bool transparent = false,
                             const QColor& transparentColor = Qt::white,
                             int transparentLevel = TokenEditor::TRANSPARENT_LEVEL_DEFAULT,
                             bool maskApplied = false,
                             const QString& maskFile = QString(),
                             bool frameApplied = false,
                             const QString& frameFile = QString(),
                             qreal zoom = 1.0,
                             const QPoint& offset = QPoint(),
                             bool browsable = true,
                             QWidget *parent = nullptr);

    explicit TokenEditDialog(const QString& tokenFilename,
    ...
    explicit TokenEditDialog(const QImage& sourceImage,
                             bool backgroundFill = false,
                             const QColor& backgroundFillColor = Qt::white,
                             bool transparent = false,
                             const QColor& transparentColor = Qt::white,
