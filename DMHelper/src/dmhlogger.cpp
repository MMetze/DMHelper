...
void DMHLogger::initialize()
{
    ...
    QString logFileName = appName + QString("-") + QDateTime::currentDateTime().toString("yyyy-MM-dd-hh-mm-ss") + QString(".log");    QString fullLogFile = logDir.filePath(logFileName);
