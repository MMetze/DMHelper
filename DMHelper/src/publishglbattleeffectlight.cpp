...
static const char *lightFragmentShader = "#version 410 core\n"
    ...
    "        // Multi-frequency flicker for organic look\n"
    "        float f1 = sin(u_time * u_flickerFrequency * 6.2831853);\n"
    "        float f2 = sin(u_time * u_flickerFrequency * 4.137 + 2.1);\n"
    "        flicker = 1.0 - u_dimAmplitude * (f1 * 0.6 + f2 * 0.4) * 0.5;\n"
    "    }\n"
    "\n"
