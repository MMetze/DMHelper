...
void CharacterDialog::setCharacter(Character* character)
{
    if(character)
    {
...
void CharacterDialog::calculateMods()
{
    if(!_character)
        return;
...
void CharacterDialog::closeEvent(QCloseEvent * event)
{
    Q_UNUSED(event);
...
void CharacterDialog::mousePressEvent(QMouseEvent * event)
{
    Q_UNUSED(event);
...
void CharacterDialog::mouseReleaseEvent(QMouseEvent * event)
{
    if(mouseDown)
    {
...
void CharacterDialog::readCharacterData()
{
    if(!_character)
        return;
...
void CharacterDialog::writeCharacterData()
{
    if(_character)
    {
...
void CharacterDialog::loadCharacterImage()
{
    ui->lblIcon->setPixmap(_character->getIconPixmap(DMHelper::PixmapSize_Showcase));
}

void CharacterDialog::updateCheckboxName(QCheckBox* chk, int abilityMod, int proficiencyBonus)
{
